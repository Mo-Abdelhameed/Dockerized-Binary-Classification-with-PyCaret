# Dockerized-Binary-Classification-Model-with-PyCaret
## Project Description
...
- KNN, Random Forest, Decision Tree, MLP, Dummy Classifier, Gradient Boosting, AdaBoost and Logistic Regression algorithms built using **SciKit-Learn**
